...
do
    ...
    ./bin/ntuplace-r -aux ./inputs/case$i/case$i"_top.aux" -out ./inputs/case$i/case$i"_top" | tee ./log/case$i/case$i"_pl_top_log"
    ./bin/ntuplace-r -aux ./inputs/case$i/case$i"_bot.aux" -out ./inputs/case$i/case$i"_bot" | tee ./log/case$i/case$i"_pl_bot_log"
